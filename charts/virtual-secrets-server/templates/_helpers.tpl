...
*/}}
{{- define "virtual-secrets-server.name" -}}
...
*/}}
{{- define "virtual-secrets-server.fullname" -}}
...
*/}}
{{- define "virtual-secrets-server.chart" -}}
...
Common labels
*/}}
{{- define "virtual-secrets-server.labels" -}}
helm.sh/chart: {{ include "virtual-secrets-server.chart" . }}
{{ include "virtual-secrets-server.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "virtual-secrets-server.selectorLabels" -}}
app.kubernetes.io/name: {{ include "virtual-secrets-server.name" . }}
...
*/}}
{{- define "virtual-secrets-server.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "virtual-secrets-server.fullname" .) .Values.serviceAccount.name }}
{{- else }}
