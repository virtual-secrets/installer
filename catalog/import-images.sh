...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-virtual-secrets-server-v0.2.0.tar $IMAGE_REGISTRY/appscode/virtual-secrets-server:v0.2.0
